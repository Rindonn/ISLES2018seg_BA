...
@ LastEditors: Rindon
@ LastEditTime: 2024-05-22 14:19:09
...
class TAU_module(nn.Module):
    def __init__(self):
        ...
        #UP BLOCK 1#
        self.upconv1 = DySample(256)
        self.conv11 = nn.Conv2d(256, 128, 1, padding=0, bias=False)
        ...
        #UP BLOCK 2#
        self.upconv2 = DySample(128)
        self.conv14 = nn.Conv2d(128, 64, 1, padding=0, bias=False)
        ...
        #UP BLOCK 3#
        self.upconv3 = DySample(64)
        self.conv17 = nn.Conv2d(64, 32, 1, padding=0, bias=False)
    ...
    def forward(self, x):
        ...
        #BLOCK 1
        x = self.upconv1(x) #256*64*64    
        x = self.conv11(x)#128*64*64  
