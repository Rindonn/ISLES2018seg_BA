...
@ LastEditors: Rindon
@ LastEditTime: 2024-07-10 12:41:06
@ Description: 多尺度注意力
'''
import torch
...
from CMUNeXtBlock2d import CMUNeXtBlock
...
class TAU_module(nn.Module):
    def __init__(self):
        ...
        #gelu
        self.pool1 = CMUNeXtBlock(32,64,2,3)
        #32*128*128
        ...
        #gelu
        self.pool2 = CMUNeXtBlock(64,128,2,3)
        #64*64*64
        ...
        #gelu
        self.pool3 = CMUNeXtBlock(128,128,2,3)
        #128*32*32
        ...
        #32*256*256
        '''
        self.swint1 = swinT.SwinT(in_channels=32, input_resolution=(256,256), num_heads=2, 
                    window_size=2, qkv_bias=False, drop=0.1,
        ...
        self.swint3 = swinT.SwinT(in_channels=32, input_resolution=(256,256), num_heads=8, 
                    ...
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintD1 = swinT.SwinT(in_channels=32, input_resolution=(256,256), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
        ...
        '''
        self.swint4 = swinT.SwinT(in_channels=64, input_resolution=(128,128), num_heads=2, 
                    window_size=2, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
                    '''
        ...
        self.swint6 = swinT.SwinT(in_channels=64, input_resolution=(128,128), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintD2 = swinT.SwinT(in_channels=64, input_resolution=(128,128), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=True)
        #128*64*64
        ...
        '''
        self.swint7 = swinT.SwinT(in_channels=128, input_resolution=(64,64), num_heads=2, 
                    window_size=2, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        '''
        ...
        self.swint9 = swinT.SwinT(in_channels=128, input_resolution=(64,64), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintD3 = swinT.SwinT(in_channels=128, input_resolution=(64,64), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=True)
        #128*32*32
        ...
        '''
        self.swintB1 = swinT.SwinT(in_channels=256, input_resolution=(32,32), num_heads=2, 
                    window_size=2, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
                    '''
        self.swintB2 = swinT.SwinT(in_channels=256, input_resolution=(32,32), num_heads=4, 
                    window_size=4, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintB3 = swinT.SwinT(in_channels=256, input_resolution=(32,32), num_heads=8, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        ...
        #self.conv19 = nn.Conv2d(32, 5, 3, padding=1, bias=False)
        #self.norm19 = nn.BatchNorm2d(5)
