...
@ LastEditors: Rindon
@ LastEditTime: 2024-10-14 10:58:00
...
class TAU_module(nn.Module):
    def __init__(self):
        ...
        #Bottleneck #
        self.convB1 = ScConv(128)
        self.normB1 = nn.GroupNorm(4, 128)
        #gelu
        self.convB2 = ScConv(128)
        self.normB2 = nn.GroupNorm(4, 128)
        self.swintB1 = swinT.SwinT(in_channels=128, input_resolution=(32,32), num_heads=4, 
                    window_size=4, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintB2 = swinT.SwinT(in_channels=128, input_resolution=(32,32), num_heads=4, 
                    window_size=8, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
        self.swintB3 = swinT.SwinT(in_channels=128, input_resolution=(32,32), num_heads=8, 
                    window_size=16, qkv_bias=False, drop=0.1,
                    attn_drop=0.1, drop_path=0.1,downsample=False)
