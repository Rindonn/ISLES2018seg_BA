...
@ LastEditors: Rindon
@ LastEditTime: 2024-09-11 12:01:05
@ Description: draw graph
'''
import matplotlib.pyplot as plt
import matplotlib.ticker as ticker

categories = ['swinTAUNet_2', 'swinTAUNet', 'swinTXUNet', 'DeepTransUnet', 'TransUnet', 'UNet', 'FCN8s']
values = [0.789482, 0.733083, 0.683273, 0.635591, 0.587543, 0.622802, 0.621229]
