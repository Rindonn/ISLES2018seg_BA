...
@ LastEditors: Rindon
@ LastEditTime: 2024-04-18 15:10:29
@ Description: 
'''
import cv2
import pandas as pd
...
dataset_m = ISLES2018Dataset('../ISLES2018_Training/TRAINING', modalities=modalities)
...
model = Unet()
model.load_state_dict(torch.load('UNet_600-fold-0.pth'))
model.to(device)
